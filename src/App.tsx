...
import CashierCashiering from "./pages/CashierCashiering";
import RetailProductSearch from "./pages/RetailProductSearch";
  ...
  <ChakraProvider theme={globalTheme}>
    <BrowserRouter>
      <Routes>
        ...
        />
        <Route
          path="/work/:outletId/:employeeId/Cashier/cashiering"
          element={
            <RequireAuth>
              <CashierCashiering />
            </RequireAuth>
        ...
        />
        <Route
          path="/work/:outletId/:employeeId/Cashier/cashiering/retail-product-search"
          element={
            <RequireAuth>
              <RetailProductSearch />
            </RequireAuth>
        ...
        />
        <Route
          path="/work/:outletId/:employeeId/Cashier/transaction"
          element={
            <RequireAuth>
              <CashierTransaction />
            </RequireAuth>
